  ...
  const apps = [
    {
      ...
      name: 'The Buffett Indicator',
      description: 'Track the key market valuation metric favored by Warren Buffett to determine if the market is overvalued or undervalued.',
      icon: 'https://images.pexels.com/photos/186461/pexels-photo-186461.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
      features: [
        'Real-time Buffett Indicator calculations',
        'Historical trend visualization',
        'Customizable alerts for valuation thresholds',
        'Market analysis based on indicator readings'
      ]
    },
    {
      id: 'stocks-value',
      name: 'Stocks Value',
      description: 'Analyze individual stocks using Warren Buffett\'s value investing principles to find potentially undervalued companies.',
          ...
          {apps.map((app) => (
            <div key={app.id} className="bg-white rounded-xl overflow-hidden shadow-lg">
              <div className="flex flex-col md:flex-row">
                <div className="md:w-2/5 p-6 flex justify-center items-center bg-gradient-to-br from-blue-900 to-blue-700">
                  <img 
                    src={app.icon} 
                    alt={app.name} 
